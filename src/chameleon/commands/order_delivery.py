...
@api.register
def order_delivery(db, orderid, firstname, surname, companyname, nip, street, streetno, placeno, postcode, place, phone, email, encryption_key=None): 
    """
    Tworzenie nowych danych wysyłki 
    ...
    sql = """
        INSERT INTO orderclientdeliverydata SET
            orderid = %(orderid)s, 
    ...
    orderclientdeliveryid = cur.lastrowid
    return orderclientdeliveryid
