...
Dla każdego polecenia dostępny jest podgląd jego źródła (link 'source' po prawej stronie). W przejrzysty sposób umożliwia on podgląd zapytań SQL i logiki która za nimi się kryje.
